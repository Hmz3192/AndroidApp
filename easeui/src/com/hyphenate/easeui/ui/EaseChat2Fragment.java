 ...
 */
public class EaseChat2Fragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector, R.drawable.em_chat_video_call_selector, R.drawable.em_chat_file_selector, R.drawable.em_chat_voice_call_selector, R.drawable.em_chat_video_call_selector};
