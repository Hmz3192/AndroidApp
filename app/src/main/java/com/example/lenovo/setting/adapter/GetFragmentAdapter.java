...
public class GetFragmentAdapter extends RecyclerView.Adapter{
    private final Context mcontext;
    private final List<OrderInfo.ResultBean.GetOrderBean> datas;
    private OnItemClickListener onItemClickListener;

    public GetFragmentAdapter(Context mcontext, List<OrderInfo.ResultBean.GetOrderBean> resultBean) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new GetFragmentAdapter.ViewHolder(View.inflate(mcontext, R.layout.order_list, null));

    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        GetFragmentAdapter.ViewHolder viewHolder = (GetFragmentAdapter.ViewHolder) holder;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private OrderInfo.ResultBean.GetOrderBean data;
        ...
        public void setData(OrderInfo.ResultBean.GetOrderBean data) {
            this.data = data;
    ...
    public interface OnItemClickListener {
        void setOnItemClickListener(OrderInfo.ResultBean.GetOrderBean data);
    }
