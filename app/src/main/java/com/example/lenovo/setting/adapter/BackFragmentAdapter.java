...
public class BackFragmentAdapter extends RecyclerView.Adapter {


    private final Context mcontext;
    private final List<OrderInfo.ResultBean.BackOrderBean> datas;
    private OnItemClickListener onItemClickListener;

    public BackFragmentAdapter(Context mcontext, List<OrderInfo.ResultBean.BackOrderBean> resultBean) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new BackFragmentAdapter.ViewHolder(View.inflate(mcontext, R.layout.order_list, null));

    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        BackFragmentAdapter.ViewHolder viewHolder = (BackFragmentAdapter.ViewHolder) holder;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private OrderInfo.ResultBean.BackOrderBean data;
        ...
        public void setData(OrderInfo.ResultBean.BackOrderBean data) {
            this.data = data;
    ...
    public interface OnItemClickListener {
        void setOnItemClickListener(OrderInfo.ResultBean.BackOrderBean data);
    }
