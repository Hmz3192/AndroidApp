...
import com.example.lenovo.home.adapter.TabAdapter.MyAdapterViewAdapter3;
...
public class TabFragment3 extends TabBaseFragment {
//    private onRecyclerItemClick mListener;
    ...
    private MyAdapterViewAdapter3 adapter;
  ...
  /*String url = "http://101.201.234.133:8080/index.jsp";*/
    ...
    private void procssData(String json) {
        ...
        if (wantBeenList.size() != 0) {
            ...
            adapter = new MyAdapterViewAdapter3(getActivity(),newSellBeanList);
    ...
    private void getDateSQL(List<WantBean> wantBeenList) {
        for (WantBean wantBeen : wantBeenList) {
            EssayBean.ResultBean.NewSellBean Bean = new EssayBean.ResultBean.NewSellBean();
...
//        try {
//            mListener = (TabFragment3.onRecyclerItemClick) activity;
