...
import com.hyphenate.easeui.ui.EaseChat2Fragment;
...
public class ChatActivity extends FragmentActivity {
    ...
    private void initListener() {
        easeChatFragment.setChatFragmentListener(new EaseChat2Fragment.EaseChatFragmentHelper() {
            @Override
    ...
    private void initData() {
        // 创建一个会话的fragment
        easeChatFragment = new EaseChat2Fragment();
